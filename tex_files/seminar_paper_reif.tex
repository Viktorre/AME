...
\begin{document}
	...
	\newline
	%[269269 rows x 572 columns]
	%[269269 rows x 588 columns]
	%add dummies for : dayofweek  ( 7 )
	%add dummies for : nat_name  ( 215 )
	%add dummies for : c_asy_type  ( 4 )
	%add dummies for : year  ( 5 )
	%add dummies for : citymonth  ( 516 )
	%add dummies for : chair  ( 259 )
	%[269269 rows x 1594 columns]
