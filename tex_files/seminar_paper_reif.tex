...
\begin{document}
	...
	Once matched.dta is created, the (stata) code puts certain temperature variables into promils and creates variables for all relevant dimensions (city, judge, year, month, day), averages of some characteristics across various dimensions, dummies and interactions between variables and/or dummies. The final dataset contains 206924 observations for 666 variables (1500? including dummies that stat creates within the regression).
	...
	\end{center}
	MORGEN SCHAUEN WIE CHAPTER RESULTS SCHREIBEN
