...
\begin{document}
	...
	\begin{abstract}
		...
		I replicate the main results of the paper "Temperature and Decisions: Evidence from 207,000 Court Cases" and evaluate the validity of the analysis. The core specification to model the effect of outdoor temperature on asylum court cases outcomes is a panel model including control variables for weather, pollution and case characteristics as well as several fixed effects for entities, time and space dynamics. The key points are... write to do anca doublecheck that yearly analysis proof that little validity...
