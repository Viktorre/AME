# -*- coding: utf-8 -*-
"""
Created on Mon Nov 22 17:47:58 2021

@author: fx236
"""


d= {'weatherdaily':['avgtemp10','skycover',
                     'pressureavgsealevel','windspeed',
                     'precipitationwaterequiv','avgdewpt'] ,
'weatherdailyt':['skycover','avgdewpt',
                      'pressureavgsealevel','windspeed',
                      'precipitationwaterequiv'],
'weathertemp':['press6t4','dew6t4','prcp6t4','wind6t4',
                    'skycover'],
'weather6t4' :['temp6t410','press6t4','dew6t4','prcp6t4',
                    'wind6t4','skycover'],
